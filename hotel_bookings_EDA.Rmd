...
hotels %>% 
  ...
  labs(x = "Arrival Date", y = "Avg Bookings",
       title = "Average bookings: July 2015 - August 2017")
...
having a large resurgence in bookings from the end of September to November which we'll have to investigate further to identify what customers are driving this increase.